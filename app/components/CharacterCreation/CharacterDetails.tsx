...
export default function CharacterDetails() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-4">
            ...
            <Link href="/game">
                <button onClick={handleBeginGame} className="mt-8 px-6 py-3 bg-green-500 text-white text-xl rounded-lg shadow-md hover:bg-green-600 transition-colors duration-300">
                    Begin Game
                </button>
            </Link>
        </div>
